...
/// ---------- Boards ----------
final boardListProvider = FutureProvider.family<List<BoardModel>, String>((
  ref,
  stageId,
) async {
...
/// ---------- Streams ----------
final streamListProvider = FutureProvider.family<List<StreamModel>, String>((
  ref,
  boardId,
) async {
...
/// ---------- Electives ----------
final electivesProvider = FutureProvider.family<List<ElectiveModel>, String>((
  ref,
  streamId,
) async {
...
final streamDetailsProvider = FutureProvider.family<StreamDetailModel?, String>(
  (ref, streamId) async {
...
/// ---------- Core Subjects ----------
final coreSubjectsProvider =
    FutureProvider.family<List<CoreSubjectModel>, String>((
      ref,
      streamId,
    ) async {
