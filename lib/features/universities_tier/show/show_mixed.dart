...
class _UniversityCourseSubjectListPageState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Universities & Courses"),      actions: [
          IconButton(
            ...
            children: coursesForUni.map((course) {
              ...
              return Padding(
                ...
                child: ExpansionTile(
                    ...
                    onTap: () {
                      if (courseDetail.isNotEmpty) {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                CourseDetailPage(detail: courseDetail.first),
                          ),
                        );
                      }
                    },
                  ...
                  subtitle: Text(
                    courseDetail.isEmpty ? "No details" : "Details available",
                  ),
                      ...
                      onTap: () {
                        if (subjectDetail.isNotEmpty) {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  CourseDetailPage(detail: subjectDetail.first),
                            ),
                          );
                        }
                      },
